...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    //-------------------------------
    init: function () {
      var _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(orderNo, hCode, shipDate, userCode, orderNoBase) {
        var _this = this;
        var URL;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _context.next = 18;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/master/detail", {
    ...
    back: function back() {
      ...
      if (this.sihRecord.STATUS == 99) {
        if (confirm("未保存データです。削除しますか？")) {
          _router__WEBPACK_IMPORTED_MODULE_1__["default"].push("/?isBack=true");
        }
      } else {
        _router__WEBPACK_IMPORTED_MODULE_1__["default"].push("/?isBack=true");
      }
    ...
    // 一時保存
    susp: function () {
      var _susp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this2 = this;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/shipping/susp", {
                'isNew': this.isNew,
    ...
    // 入力確定
    conf: function () {
      var _conf = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/shipping/conf", {
                'isNew': this.isNew,
                'sihRecord': this.sihRecord,
                'sidRecords': this.sidRecords
              }).then(function (response) {
    ...
    // 出荷完了
    comp: function () {
      var _comp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/shipping/comp", {
                'isNew': this.isNew,
                'sihRecord': this.sihRecord,
                'sidRecords': this.sidRecords
              }).then(function (response) {
    ...
    // 削除
    del: function () {
      var _del = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/api/shipping/", {
                data: {
                  'orderNo': this.sihRecord["ORDER_NO"]
                }
              }).then(function (response) {
                alert("削除しました。");
                _router__WEBPACK_IMPORTED_MODULE_1__["default"].push("/?isBack=true");
    ...
    instructionPrint: function () {
      var _instructionPrint = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    ...
    // 伝票印刷
    slipPrint: function () {
      var _slipPrint = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    ...
    openStocksDetail: function openStocksDetail(itemCode) {
      if (_store__WEBPACK_IMPORTED_MODULE_2__["default"].state.stocksDetailURL == null || _store__WEBPACK_IMPORTED_MODULE_2__["default"].state.stocksDetailURL == "") {
        alert("在庫詳細のURLが設定されていません");
        return;
      }
      var linkURL = _store__WEBPACK_IMPORTED_MODULE_2__["default"].state.stocksDetailURL;
      linkURL += "?sub=1";
    ...
    // 商品(フォーカス外れ時イベント)
    itemBlur: function () {
      var _itemBlur = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(index) {
        var _this3 = this;
    ...
    loadingPlacBlur: function () {
      var _loadingPlacBlur = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(index) {
        var count, places;
    ...
    getItems: function () {
      var _getItems = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
        var _this11 = this;
    ...
    setNextField: function setNextField() {
      ...
      this.nextFields.push({
        'id': 'conf',
        'disabled': !(this.sihRecord.STATUS == 0 || this.sihRecord.STATUS == 1 || this.sihRecord.STATUS == 99)
      });
      this.nextFields.push({
        'id': 'comp',
  ...
  //---------------------------------------------------------------------------
  mounted: function () {
    var _mounted = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
  ...
  watch: {
    ...
    'sihRecord.CUSTOMER_CODE': function () {
      var _sihRecordCUSTOMER_CODE = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(code) {
        var _this12 = this;
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              _context12.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/master/deliveries', {
    ...
    'sihRecord.DELIVERY_CODE': function () {
      var _sihRecordDELIVERY_CODE = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(code) {
    ...
    'sihRecord.SUPPLIER_CODE': function () {
      var _sihRecordSUPPLIER_CODE = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(code) {
    ...
    'sihRecord.LOADING_RATE': function () {
      var _sihRecordLOADING_RATE = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15() {
