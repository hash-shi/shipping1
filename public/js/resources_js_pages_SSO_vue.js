...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getUser: function () {
      var _getUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userCode) {
        var _this = this;
    ...
    getConfig: function () {
      var _getConfig = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this2 = this;
    ...
    var _mounted = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 7:
            if (_store__WEBPACK_IMPORTED_MODULE_1__["default"].state.userCode != null && _store__WEBPACK_IMPORTED_MODULE_1__["default"].state.userName != null && (mode == "ship" || mode == "qr") && _store__WEBPACK_IMPORTED_MODULE_1__["default"].state.officeCode != null) {
              if (mode == "ship") {
