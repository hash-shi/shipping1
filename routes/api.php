...
// 出荷指示登録更新削除
Route::get('shippingDetail/{orderNo}'                                            , "App\Http\Controllers\api\ShippingController@fix");
Route::get('shippingDetail/{orderNo}/{hCode}/{shipDate}/{userCode}'              , "App\Http\Controllers\api\ShippingController@new");
Route::get('shippingDetail/{orderNo}/{hCode}/{shipDate}/{userCode}/{orderNoBase}', "App\Http\Controllers\api\ShippingController@copy");
